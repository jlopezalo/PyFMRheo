...
def HertzFit(
    ...
    p0, poisson_ratio=0.5, fit_line=False, sample_height=None, bec_model=None):
    ...
    params.add('slope', value=p0[2], vary=fit_line)
    params.add('E0', value=p0[3], min=0)

    fixed_params = {
        'poisson_ratio': poisson_ratio, 'indenter_shape': ind_shape,
        'tip_parameter':tip_parameter, 'sample_height': sample_height, 'bec_model': bec_model
    }
