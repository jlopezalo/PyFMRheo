...
def doPiezoCharacterization(file_path, deflection_sensitivity=None, spring_constant=None):
    ...
    file_results = pd.DataFrame(columns=["file_id", "curve_idx", "frequency", "fi_degrees", "amp_quotient", "inVols"])
    ...
    for curve_idx in range(len(file_data)):
        ...
        file_results["fi_degrees"] = fi_results
        file_results["amp_quotient"] = amp_quotient_results
